...
n_gram_size_file = 'n_gram_sizes.txt'
# parameters
...
cluster_min = 1
# size of max letter cluster
cluster_max = int(subprocess.check_output(['tail', '-1', n_gram_size_file]))
ordy = [1]
...
# language vectors from lang_texts. do not format these files?
# so cluster_size is determined in raw_texts. is that okay?
# should be loop in decreasing order for cluster_size?
