...
for file_name in all_texts:
    ...
    subprocess.call(["cat", file_name, "|", "tr", "-d", "[:space:]", ">", "AliceInWonderland.txt"])
    subprocess.call(["cat", "AliceInWonderland.txt", "|", "tr", "-d", "[:punct:]"])
    # converts uppercase to lower case
    subprocess.call(["cat", "AliceInWonderland.txt", "|", "tr", "[:upper:]", "[:lower:]"])
